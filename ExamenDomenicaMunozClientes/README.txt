...
a persistence unit "ExamenDomenicaMunozClientesPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenDomenicaMunozClientes\pom.xml":
...
artifact ("ExamenDomenicaMunozClientes.war") is already built. You can build
